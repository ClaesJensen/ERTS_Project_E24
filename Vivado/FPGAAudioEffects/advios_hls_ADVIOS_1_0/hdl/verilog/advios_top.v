...
wire [4 - 1:0] sig_ADVIOS_inCtrl;

wire sig_ADVIOS_inReset;



ADVIOS ADVIOS_U(
    .inCtrl(sig_ADVIOS_inCtrl),
    .inReset(sig_ADVIOS_inReset),
    .inClk(aclk),
    .inSwitch(inSwitch),
    .outLeds(outLeds)
);
