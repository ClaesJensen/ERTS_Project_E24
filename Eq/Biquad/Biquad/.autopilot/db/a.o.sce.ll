...
define void @"Biquad::process"(i1* %inClk, i1* %inReset, i32* %inData, i32* %outData) {
  ...
  call void @llvm.dbg.value(metadata !{i1* %inClk}, i64 0, metadata !111), !dbg !1374
  call void @llvm.dbg.value(metadata !{i1* %inReset}, i64 0, metadata !1375), !dbg !1374
  call void @llvm.dbg.value(metadata !{i32* %inData}, i64 0, metadata !1376), !dbg !1374
  call void @llvm.dbg.value(metadata !{i32* %outData}, i64 0, metadata !1392), !dbg !1374
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str2, i32 0, i32 0, i1* %inClk) nounwind, !dbg !1403
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [8 x i8]* @p_str3, i32 0, i32 0, i1* %inReset) nounwind, !dbg !1405
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [7 x i8]* @p_str5, i32 0, i32 0, i32* %inData) nounwind, !dbg !1406
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str6, i32 0, i32 0, i32* %outData) nounwind, !dbg !1407
  call void (...)* @_ssdm_op_SpecProcessDef([7 x i8]* @p_str, i32 2, [8 x i8]* @p_str7) nounwind, !dbg !1408
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str8), !dbg !1409
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str9) nounwind, !dbg !1410
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !1411
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !1412), !dbg !1411
  call void (...)* @_ssdm_op_SpecIFCore(i32* %inData, [1 x i8]* @p_str9, [10 x i8]* @p_str11, [1 x i8]* @p_str9, i32 -1, [1 x i8]* @p_str9, [1 x i8]* @p_str9, [1 x i8]* @p_str9, [1 x i8]* @p_str9, [22 x i8]* @p_str12), !dbg !1413
  call void (...)* @_ssdm_op_SpecIFCore(i32* %outData, [1 x i8]* @p_str9, [10 x i8]* @p_str11, [1 x i8]* @p_str9, i32 -1, [1 x i8]* @p_str9, [1 x i8]* @p_str9, [1 x i8]* @p_str9, [1 x i8]* @p_str9, [22 x i8]* @p_str12), !dbg !1414
  call void @llvm.dbg.declare(metadata !{[5 x i32]* %samples_V}, metadata !1415), !dbg !1421
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !1422
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str8, i32 %tmp_2), !dbg !1423
  %samples_V_addr = getelementptr [5 x i32]* %samples_V, i32 0, i32 0, !dbg !1424
  %samples_V_addr_1 = getelementptr [5 x i32]* %samples_V, i32 0, i32 3, !dbg !1429
  %samples_V_addr_2 = getelementptr [5 x i32]* %samples_V, i32 0, i32 4, !dbg !1429
  %samples_V_addr_3 = getelementptr [5 x i32]* %samples_V, i32 0, i32 1, !dbg !1431
  %samples_V_addr_4 = getelementptr [5 x i32]* %samples_V, i32 0, i32 2, !dbg !1431
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2, !dbg !1433
...
_ZN7_ap_sc_7sc_core4waitEi.exit2:                 ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit, %0
  ...
  %val_V = call i32 @_ssdm_op_Read.ap_auto.volatile.i32P(i32* %inData), !dbg !1434
  call void @llvm.dbg.value(metadata !{i32 %val_V}, i64 0, metadata !1452), !dbg !1434
  store i32 %val_V, i32* %samples_V_addr, align 4, !dbg !1424
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !1454
  br label %1, !dbg !1461
...
; <label>:1                                       ; preds = %_ZrsILi128ELb1EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit, %_ZN7_ap_sc_7sc_core4waitEi.exit2
  ...
  %exitcond = icmp eq i3 %t_V, -3, !dbg !1463
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 5, i64 5, i64 5)
  %i_V = add i3 %t_V, 1, !dbg !1464
  br i1 %exitcond, label %_ZN7_ap_sc_7sc_core4waitEi.exit, label %_ZrsILi128ELb1EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit, !dbg !1463

_ZrsILi128ELb1EE11ap_int_baseIXT_EXT0_EXleT_Li64EEERKS1_i.exit: ; preds = %1
  %tmp = zext i3 %t_V to i32, !dbg !2256
  %coeffs_addr = getelementptr [5 x i25]* @coeffs, i32 0, i32 %tmp, !dbg !2258
  %coeffs_load = load i25* %coeffs_addr, align 4, !dbg !2258
  %samples_V_addr_5 = getelementptr [5 x i32]* %samples_V, i32 0, i32 %tmp, !dbg !2595
  %samples_V_load_2 = load i32* %samples_V_addr_5, align 4, !dbg !2595
  %lhs_V_cast = sext i25 %coeffs_load to i56, !dbg !2598
  %rhs_V_cast = sext i32 %samples_V_load_2 to i56, !dbg !2598
  %r_V = mul i56 %lhs_V_cast, %rhs_V_cast, !dbg !2605
  call void @llvm.dbg.value(metadata !{i56 %r_V}, i64 0, metadata !2614), !dbg !2605
  %phitmp = call i32 @_ssdm_op_PartSelect.i32.i56.i32.i32(i56 %r_V, i32 24, i32 55), !dbg !2621
  %result_V = add i32 %phitmp, %v_V, !dbg !2627
  call void @llvm.dbg.value(metadata !{i32 %result_V}, i64 0, metadata !2630), !dbg !2627
  call void @llvm.dbg.value(metadata !{i3 %t_V}, i64 0, metadata !2632), !dbg !2638
  call void @llvm.dbg.value(metadata !{i3 %i_V}, i64 0, metadata !2639), !dbg !1464
  br label %1, !dbg !2255

_ZN7_ap_sc_7sc_core4waitEi.exit:                  ; preds = %1
  %samples_V_load = load i32* %samples_V_addr_1, align 4, !dbg !1429
  store i32 %samples_V_load, i32* %samples_V_addr_2, align 4, !dbg !1429
  store i32 %v_V, i32* %samples_V_addr_1, align 4, !dbg !2722
  %samples_V_load_1 = load i32* %samples_V_addr_3, align 4, !dbg !1431
  store i32 %samples_V_load_1, i32* %samples_V_addr_4, align 4, !dbg !1431
  store i32 %val_V, i32* %samples_V_addr_3, align 4, !dbg !2724
  call void @llvm.dbg.value(metadata !{i32 %v_V}, i64 0, metadata !2726), !dbg !2734
  call void @llvm.dbg.value(metadata !{i32 %v_V}, i64 0, metadata !2739), !dbg !2747
  call void @_ssdm_op_Write.ap_auto.volatile.i32P(i32* %outData, i32 %v_V), !dbg !2749
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !2753
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2, !dbg !2755
}
...
define weak void @"Biquad::Biquad"(i1* %inClk, i1* %inReset, i32* %inData, i32* %outData) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %inData), !map !103
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %outData), !map !107
  call void @llvm.dbg.value(metadata !{i1* %inClk}, i64 0, metadata !2756), !dbg !2759
  call void @llvm.dbg.value(metadata !{i1* %inReset}, i64 0, metadata !2760), !dbg !2759
  call void @llvm.dbg.value(metadata !{i32* %inData}, i64 0, metadata !2761), !dbg !2759
  call void @llvm.dbg.value(metadata !{i32* %outData}, i64 0, metadata !2762), !dbg !2759
  call void (...)* @_ssdm_op_SpecTopModule([7 x i8]* @p_str, [7 x i8]* @p_str) nounwind, !dbg !2763
  %Biquad_ssdm_threa = load i1* @Biquad_ssdm_thread_M_process, align 1, !dbg !2765
  br i1 %Biquad_ssdm_threa, label %1, label %2, !dbg !2765

; <label>:1                                       ; preds = %0
  call void @"Biquad::process"(i1* %inClk, i1* %inReset, i32* %inData, i32* %outData), !dbg !2766
  unreachable

; <label>:2                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecProcessDecl([7 x i8]* @p_str, i32 2, [8 x i8]* @p_str7) nounwind, !dbg !2767
  call void (...)* @_ssdm_op_SpecSensitive([8 x i8]* @p_str7, [6 x i8]* @p_str2, i1* %inClk, i32 1) nounwind, !dbg !2768
  call void (...)* @_ssdm_op_SpecSensitive([8 x i8]* @p_str7, [8 x i8]* @p_str3, i1* %inReset, i32 3) nounwind, !dbg !2769
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str2, i32 0, i32 0, i1* %inClk) nounwind, !dbg !2770
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [8 x i8]* @p_str3, i32 0, i32 0, i1* %inReset) nounwind, !dbg !2771
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [7 x i8]* @p_str5, i32 0, i32 0, i32* %inData) nounwind, !dbg !2772
  call void (...)* @_ssdm_op_SpecPort([7 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str6, i32 0, i32 0, i32* %outData) nounwind, !dbg !2773
  ret void, !dbg !2774
}
