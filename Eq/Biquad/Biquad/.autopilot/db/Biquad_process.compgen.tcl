...
set ID 1
set MemName Biquad_process_cobkb
...
set TrueReset 0
set IsROM 1
set ROMData { "0011111101101110011001100" "1000000110101011101001100" "0011111011100111101110100" "0111111001010100010110100" "1100000110101001110111111" }
...
# Memory (RAM/ROM)  definition:
set ID 2
set MemName Biquad_process_sacud
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 32
set AddrRange 5
...
set portmap { }
set metadata { -bus_bundle biquad_io}
if {${::AESL::PGuard_autoexp_gen}} {
