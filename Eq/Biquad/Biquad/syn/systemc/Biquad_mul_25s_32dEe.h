...
#ifndef __Biquad_mul_25s_32dEe__HH__
#define __Biquad_mul_25s_32dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Biquad_mul_25s_32dEe) {
    ...
    SC_CTOR(Biquad_mul_25s_32dEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
