...
entity biquadv2end_biquadv2_s_axi is
generic (
...
end entity biquadv2end_biquadv2_s_axi;
...
--        others   - reserved
-- 0x34 : reserved
-- 0x38 : Data signal of outDataLeft_V
--        bit 23~0 - outDataLeft_V[23:0] (Read)
--        others   - reserved
-- 0x3c : Control signal of outDataLeft_V
--        bit 0  - outDataLeft_V_ap_vld (Read/COR)
--        others - reserved
-- 0x40 : Data signal of outDataRight_V
--        bit 23~0 - outDataRight_V[23:0] (Read)
--        others   - reserved
-- 0x44 : Control signal of outDataRight_V
--        bit 0  - outDataRight_V_ap_vld (Read/COR)
--        others - reserved
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of biquadv2end_biquadv2_s_axi is
    ...
    constant ADDR_OUTDATALEFT_V_DATA_0  : INTEGER := 16#38#;
    constant ADDR_OUTDATALEFT_V_CTRL    : INTEGER := 16#3c#;
    constant ADDR_OUTDATARIGHT_V_DATA_0 : INTEGER := 16#40#;
    constant ADDR_OUTDATARIGHT_V_CTRL   : INTEGER := 16#44#;
    ...
    signal int_outDataLeft_V   : UNSIGNED(23 downto 0) := (others => '0');
    signal int_outDataLeft_V_ap_vld : STD_LOGIC;
    signal int_outDataRight_V  : UNSIGNED(23 downto 0) := (others => '0');
    signal int_outDataRight_V_ap_vld : STD_LOGIC;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_OUTDATALEFT_V_DATA_0 =>
                        rdata_data <= RESIZE(int_outDataLeft_V(23 downto 0), 32);
                    when ADDR_OUTDATALEFT_V_CTRL =>
                        rdata_data <= (0 => int_outDataLeft_V_ap_vld, others => '0');
                    when ADDR_OUTDATARIGHT_V_DATA_0 =>
                        rdata_data <= RESIZE(int_outDataRight_V(23 downto 0), 32);
                    when ADDR_OUTDATARIGHT_V_CTRL =>
                        rdata_data <= (0 => int_outDataRight_V_ap_vld, others => '0');
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_outDataLeft_V <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (outDataLeft_V_ap_vld = '1') then
                    int_outDataLeft_V <= UNSIGNED(outDataLeft_V); -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_outDataLeft_V_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (outDataLeft_V_ap_vld = '1') then
                    int_outDataLeft_V_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_OUTDATALEFT_V_CTRL) then
                    int_outDataLeft_V_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_outDataRight_V <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (outDataRight_V_ap_vld = '1') then
                    int_outDataRight_V <= UNSIGNED(outDataRight_V); -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_outDataRight_V_ap_vld <= '0';
            elsif (ACLK_EN = '1') then
                if (outDataRight_V_ap_vld = '1') then
                    int_outDataRight_V_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_OUTDATARIGHT_V_CTRL) then
                    int_outDataRight_V_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
