...
#ifndef __biquadv2end_mul_2bkb__HH__
#define __biquadv2end_mul_2bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(biquadv2end_mul_2bkb) {
    ...
    SC_CTOR(biquadv2end_mul_2bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
