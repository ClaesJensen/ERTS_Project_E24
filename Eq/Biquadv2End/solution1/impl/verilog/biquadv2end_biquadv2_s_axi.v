...
`timescale 1ns/1ps
module biquadv2end_biquadv2_s_axi
#(parameter
    ...
    input  wire [23:0]                   outDataLeft_V,
    input  wire                          outDataLeft_V_ap_vld,
    input  wire [23:0]                   outDataRight_V,
    input  wire                          outDataRight_V_ap_vld
);
//------------------------Address Info-------------------
...
localparam
    ...
    ADDR_OUTDATALEFT_V_DATA_0  = 7'h38,
    ADDR_OUTDATALEFT_V_CTRL    = 7'h3c,
    ADDR_OUTDATARIGHT_V_DATA_0 = 7'h40,
    ADDR_OUTDATARIGHT_V_CTRL   = 7'h44,
    WRIDLE                     = 2'd0,
    WRDATA                     = 2'd1,
    WRRESP                     = 2'd2,
    WRRESET                    = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [23:0]                   int_outDataLeft_V = 'b0;
    reg                           int_outDataLeft_V_ap_vld;
    reg  [23:0]                   int_outDataRight_V = 'b0;
    reg                           int_outDataRight_V_ap_vld;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_OUTDATALEFT_V_DATA_0: begin
                    rdata <= int_outDataLeft_V[23:0];
                end
                ADDR_OUTDATALEFT_V_CTRL: begin
                    rdata[0] <= int_outDataLeft_V_ap_vld;
                end
                ADDR_OUTDATARIGHT_V_DATA_0: begin
                    rdata <= int_outDataRight_V[23:0];
                end
                ADDR_OUTDATARIGHT_V_CTRL: begin
                    rdata[0] <= int_outDataRight_V_ap_vld;
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (outDataLeft_V_ap_vld)
            int_outDataLeft_V <= outDataLeft_V;
    end
end

// int_outDataLeft_V_ap_vld
always @(posedge ACLK) begin
    if (ARESET)
        int_outDataLeft_V_ap_vld <= 1'b0;
    else if (ACLK_EN) begin
        if (outDataLeft_V_ap_vld)
            int_outDataLeft_V_ap_vld <= 1'b1;
        else if (ar_hs && raddr == ADDR_OUTDATALEFT_V_CTRL)
            int_outDataLeft_V_ap_vld <= 1'b0; // clear on read
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_outDataRight_V <= 0;
    else if (ACLK_EN) begin
        if (outDataRight_V_ap_vld)
            int_outDataRight_V <= outDataRight_V;
    end
end

// int_outDataRight_V_ap_vld
always @(posedge ACLK) begin
    if (ARESET)
        int_outDataRight_V_ap_vld <= 1'b0;
    else if (ACLK_EN) begin
        if (outDataRight_V_ap_vld)
            int_outDataRight_V_ap_vld <= 1'b1;
        else if (ar_hs && raddr == ADDR_OUTDATARIGHT_V_CTRL)
            int_outDataRight_V_ap_vld <= 1'b0; // clear on read
    end
end
