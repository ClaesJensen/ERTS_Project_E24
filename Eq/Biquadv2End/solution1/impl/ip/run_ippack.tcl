...
set Library     "hls"
set IPName      "biquadv2end"
set Version     "1.0"
set DisplayName "Biquadv2end"
set Revision    "2113879029"
...
set Interfaces {
    s_axi_biquadv2 {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_biquadv2"
        param_prefix "C_S_AXI_BIQUADV2"
        addr_bits "7"
        port_width "AWADDR 7 WDATA 32 WSTRB 4 ARADDR 7 RDATA 32"
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 b0_a0_V W 0x0 "Data signal of b0_a0_V" {{0 27 b0_a0_V W 0 "Bit 26 to 0 Data signal of b0_a0_V"} {27 5 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 b1_a0_V W 0x0 "Data signal of b1_a0_V" {{0 27 b1_a0_V W 0 "Bit 26 to 0 Data signal of b1_a0_V"} {27 5 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 b2_a0_V W 0x0 "Data signal of b2_a0_V" {{0 27 b2_a0_V W 0 "Bit 26 to 0 Data signal of b2_a0_V"} {27 5 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 a1_a0_V W 0x0 "Data signal of a1_a0_V" {{0 27 a1_a0_V W 0 "Bit 26 to 0 Data signal of a1_a0_V"} {27 5 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 a2_a0_V W 0x0 "Data signal of a2_a0_V" {{0 27 a2_a0_V W 0 "Bit 26 to 0 Data signal of a2_a0_V"} {27 5 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 outDataLeft_V R 0x0 "Data signal of outDataLeft_V" {{0 24 outDataLeft_V R 0 "Bit 23 to 0 Data signal of outDataLeft_V"} {24 8 RESERVED R 0 "Reserved.  0s on read."}}} {0x3c outDataLeft_V_ctrl R 0x0 "Control signal of outDataLeft_V" {{0 1 outDataLeft_V_ap_vld R 0 "Control signal outDataLeft_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 outDataRight_V R 0x0 "Data signal of outDataRight_V" {{0 24 outDataRight_V R 0 "Bit 23 to 0 Data signal of outDataRight_V"} {24 8 RESERVED R 0 "Reserved.  0s on read."}}} {0x44 outDataRight_V_ctrl R 0x0 "Control signal of outDataRight_V" {{0 1 outDataRight_V_ap_vld R 0 "Control signal outDataRight_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 49 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/lions/Desktop/Github/ERTS_Project_E24/Eq/Biquadv2End/biquadv2end.cpp}
if {$enable_xo_gen} {
