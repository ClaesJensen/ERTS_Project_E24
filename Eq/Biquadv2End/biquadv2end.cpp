...
//PORTS MARKED AS NONE (no special behaviour).
#pragma HLS INTERFACE ap_hs port=inDataLeft
#pragma HLS INTERFACE ap_hs port=inDataRight

//SLAVE AXILITE PORTS
#pragma HLS INTERFACE s_axilite port=outDataLeft bundle=biquadv2
#pragma HLS INTERFACE s_axilite port=outDataRight bundle=biquadv2
