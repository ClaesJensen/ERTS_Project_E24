set C_TypeInfoList {{ 
"biquadv2" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"b0_a0": [[],"0"] }, {"b1_a0": [[],"0"] }, {"b2_a0": [[],"0"] }, {"a1_a0": [[],"0"] }, {"a2_a0": [[],"0"] }, {"inData": [[],"1"] }, {"outData": [[],{ "pointer": "2"}] }],[],""], 
"2": [ "outData_t", {"typedef": [[[],"3"],""]}], 
"0": [ "coeff_t", {"typedef": [[[],"4"],""]}], 
"1": [ "inData_t", {"typedef": [[[],"3"],""]}], 
"4": [ "ap_fixed<27, 3, 0, 0, 0>", {"hls_type": {"ap_fixed": [[[[], {"scalar": { "int": 27}}],[[], {"scalar": { "int": 3}}],[[], {"scalar": { "5": 0}}],[[], {"scalar": { "6": 0}}],[[], {"scalar": { "int": 0}}]],""]}}], 
...
"3": [ "ap_fixed<24, 1, 0, 0, 0>", {"hls_type": {"ap_fixed": [[[[], {"scalar": { "int": 24}}],[[], {"scalar": { "int": 1}}],[[], {"scalar": { "5": 0}}],[[], {"scalar": { "6": 0}}],[[], {"scalar": { "int": 0}}]],""]}}]
}}
...
set C_modelArgMapList {[ 
	{ "Name" : "b0_a0_V", "interface" : "axi_slave", "bundle":"biquadv2","type":"ap_none","bitwidth" : 27, "direction" : "READONLY", "bitSlice":[{"low":0,"up":26,"cElement": [{"cName": "b0_a0.V","cData": "int27","bit_use": { "low": 0,"up": 26},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	...
 	{ "Name" : "inData_V", "interface" : "axi_slave", "bundle":"biquadv2","type":"ap_none","bitwidth" : 24, "direction" : "READONLY", "bitSlice":[{"low":0,"up":23,"cElement": [{"cName": "inData.V","cData": "int24","bit_use": { "low": 0,"up": 23},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":56}, "offset_end" : {"in":63}} , 
 	{ "Name" : "outData_V", "interface" : "axi_slave", "bundle":"biquadv2","type":"ap_vld","bitwidth" : 24, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":23,"cElement": [{"cName": "outData.V","cData": "int24","bit_use": { "low": 0,"up": 23},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":64}, "offset_end" : {"out":71}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_biquadv2_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "biquadv2", "role": "AWADDR" },"address":[{"name":"biquadv2","role":"start","value":"0","valid_bit":"0"},{"name":"biquadv2","role":"continue","value":"0","valid_bit":"4"},{"name":"biquadv2","role":"auto_start","value":"0","valid_bit":"7"},{"name":"b0_a0_V","role":"data","value":"16"},{"name":"b1_a0_V","role":"data","value":"24"},{"name":"b2_a0_V","role":"data","value":"32"},{"name":"a1_a0_V","role":"data","value":"40"},{"name":"a2_a0_V","role":"data","value":"48"},{"name":"inData_V","role":"data","value":"56"}] },
	...
	{ "name": "s_axi_biquadv2_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "biquadv2", "role": "ARADDR" },"address":[{"name":"biquadv2","role":"start","value":"0","valid_bit":"0"},{"name":"biquadv2","role":"done","value":"0","valid_bit":"1"},{"name":"biquadv2","role":"idle","value":"0","valid_bit":"2"},{"name":"biquadv2","role":"ready","value":"0","valid_bit":"3"},{"name":"biquadv2","role":"auto_start","value":"0","valid_bit":"7"},{"name":"outData_V","role":"data","value":"64"}, {"name":"outData_V","role":"valid","value":"68","valid_bit":"0"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			...
			{"Name" : "coeffs_V", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "samples_V", "Type" : "Memory", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.coeffs_V_U", "Parent" : "0"},
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.biquadv2_mul_27s_bkb_U0", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	biquadv2 {
		...
		outData_V {Type O LastRead -1 FirstWrite 5}
		coeffs_V {Type IO LastRead -1 FirstWrite -1}
