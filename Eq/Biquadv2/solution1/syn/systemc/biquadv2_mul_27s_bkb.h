...
#ifndef __biquadv2_mul_27s_bkb__HH__
#define __biquadv2_mul_27s_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(biquadv2_mul_27s_bkb) {
    ...
    SC_CTOR(biquadv2_mul_27s_bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
