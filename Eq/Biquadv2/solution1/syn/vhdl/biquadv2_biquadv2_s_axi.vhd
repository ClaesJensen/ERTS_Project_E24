...
end entity biquadv2_biquadv2_s_axi;
...
architecture behave of biquadv2_biquadv2_s_axi is
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_OUTDATA_V_DATA_0 =>
                        rdata_data <= RESIZE(int_outData_V(23 downto 0), 32);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_INDATA_V_DATA_0) then
                    int_inData_V(23 downto 0) <= (UNSIGNED(WDATA(23 downto 0)) and wmask(23 downto 0)) or ((not wmask(23 downto 0)) and int_inData_V(23 downto 0));
                end if;
            end if;
        end if;
    end process;
