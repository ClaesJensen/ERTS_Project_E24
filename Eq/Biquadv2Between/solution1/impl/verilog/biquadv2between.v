...
(* CORE_GENERATION_INFO="biquadv2between,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.416000,HLS_SYN_LAT=49,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=3,HLS_SYN_FF=1602,HLS_SYN_LUT=1331}" *)
...
parameter    C_S_AXI_BIQUADV2_ADDR_WIDTH = 6;
...
biquadv2between_mcud #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 27 ),
    .din1_WIDTH( 24 ),
    .dout_WIDTH( 51 ))
biquadv2between_mcud_U0(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .din0(grp_fu_279_p0),
    .din1(grp_fu_279_p1),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & ~((1'b0 == inDataRight_V_ap_vld) | (1'b0 == inDataLeft_V_ap_vld)))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state1) & ~((1'b0 == inDataRight_V_ap_vld) | (1'b0 == inDataLeft_V_ap_vld))) | (1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state14) | ((1'b1 == ap_CS_fsm_state16) & (ap_block_state16_io == 1'b0)) | (1'b1 == ap_CS_fsm_state2) | (1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state15) | (1'b1 == ap_CS_fsm_state17))) begin
        array_r_we0 = 1'b1;
    end else begin
        array_r_we0 = 1'b0;
    end
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state1) & ~((1'b0 == inDataRight_V_ap_vld) | (1'b0 == inDataLeft_V_ap_vld))) | (1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state14) | ((1'b1 == ap_CS_fsm_state16) & (ap_block_state16_io == 1'b0)) | (1'b1 == ap_CS_fsm_state2) | (1'b1 == ap_CS_fsm_state15) | (1'b1 == ap_CS_fsm_state17))) begin
        array_r_we1 = 1'b1;
    end else begin
        array_r_we1 = 1'b0;
    end
...
always @ (*) begin
    ap_block_state1 = ((1'b0 == inDataRight_V_ap_vld) | (1'b0 == inDataLeft_V_ap_vld));
end
