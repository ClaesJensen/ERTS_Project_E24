...
entity biquadv2between is
generic (
    C_S_AXI_BIQUADV2_ADDR_WIDTH : INTEGER := 6;
...
architecture behav of biquadv2between is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "biquadv2between,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.416000,HLS_SYN_LAT=49,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=3,HLS_SYN_FF=1602,HLS_SYN_LUT=1331}";
    ...
    component biquadv2between_mcud IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component biquadv2between_abkb IS
    generic (
        DataWidth : INTEGER;
    ...
    component biquadv2between_biquadv2_s_axi IS
    generic (
...
begin
    array_r_U : component biquadv2between_abkb
    generic map (
        DataWidth => 27,
        AddressRange => 15,
        AddressWidth => 4)
    ...
    biquadv2between_biquadv2_s_axi_U : component biquadv2between_biquadv2_s_axi
    generic map (
    ...
    biquadv2between_mcud_U0 : component biquadv2between_mcud
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 27,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = inDataRight_V_ap_vld) or (ap_const_logic_0 = inDataLeft_V_ap_vld))))) then
    ...
    ap_NS_fsm_assign_proc : process (inDataLeft_V_ap_vld, inDataRight_V_ap_vld, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state16, ap_CS_fsm_state5, tmp_2_fu_313_p2, ap_block_state16_io)
    begin
        case ap_CS_fsm is
    ...
    ap_block_state1_assign_proc : process(inDataLeft_V_ap_vld, inDataRight_V_ap_vld)
    begin
                ap_block_state1 <= ((ap_const_logic_0 = inDataRight_V_ap_vld) or (ap_const_logic_0 = inDataLeft_V_ap_vld));
    end process;
    ...
    array_r_address0_assign_proc : process(ap_CS_fsm_state1, ap_CS_fsm_state16, ap_CS_fsm_state4, ap_CS_fsm_state5, tmp_2_fu_313_p2, ap_CS_fsm_state13, ap_CS_fsm_state14, addr5_cast_fu_340_p1, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state15, ap_CS_fsm_state17)
    begin
    ...
    array_r_address1_assign_proc : process(ap_CS_fsm_state1, ap_CS_fsm_state16, ap_CS_fsm_state4, ap_CS_fsm_state5, tmp_2_fu_313_p2, ap_CS_fsm_state6, ap_CS_fsm_state13, ap_CS_fsm_state14, tmp_3_fu_325_p1, addr1_cast_fu_354_p1, ap_CS_fsm_state2, ap_CS_fsm_state15, ap_CS_fsm_state17)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state16)) then 
    ...
    array_r_ce0_assign_proc : process(inDataLeft_V_ap_vld, inDataRight_V_ap_vld, ap_CS_fsm_state1, ap_CS_fsm_state16, ap_CS_fsm_state4, ap_CS_fsm_state5, tmp_2_fu_313_p2, ap_CS_fsm_state13, ap_CS_fsm_state14, ap_block_state16_io, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state15, ap_CS_fsm_state17)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = inDataRight_V_ap_vld) or (ap_const_logic_0 = inDataLeft_V_ap_vld)))) or (ap_const_logic_1 = ap_CS_fsm_state4) or ((ap_const_logic_1 = ap_CS_fsm_state5) and (tmp_2_fu_313_p2 = ap_const_lv1_0)) or (ap_const_logic_1 = ap_CS_fsm_state13) or (ap_const_logic_1 = ap_CS_fsm_state14) or ((ap_const_logic_1 = ap_CS_fsm_state16) and (ap_block_state16_io = ap_const_boolean_0)) or (ap_const_logic_1 = ap_CS_fsm_state2) or (ap_const_logic_1 = ap_CS_fsm_state3) or ((ap_const_logic_1 = ap_CS_fsm_state5) and (tmp_2_fu_313_p2 = ap_const_lv1_1)) or (ap_const_logic_1 = ap_CS_fsm_state15) or (ap_const_logic_1 = ap_CS_fsm_state17))) then 
    ...
    array_r_ce1_assign_proc : process(inDataLeft_V_ap_vld, inDataRight_V_ap_vld, ap_CS_fsm_state1, ap_CS_fsm_state16, ap_CS_fsm_state4, ap_CS_fsm_state5, tmp_2_fu_313_p2, ap_CS_fsm_state6, ap_CS_fsm_state13, ap_CS_fsm_state14, ap_block_state16_io, ap_CS_fsm_state2, ap_CS_fsm_state15, ap_CS_fsm_state17)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = inDataRight_V_ap_vld) or (ap_const_logic_0 = inDataLeft_V_ap_vld)))) or (ap_const_logic_1 = ap_CS_fsm_state4) or ((ap_const_logic_1 = ap_CS_fsm_state5) and (tmp_2_fu_313_p2 = ap_const_lv1_0)) or (ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state13) or (ap_const_logic_1 = ap_CS_fsm_state14) or ((ap_const_logic_1 = ap_CS_fsm_state16) and (ap_block_state16_io = ap_const_boolean_0)) or (ap_const_logic_1 = ap_CS_fsm_state2) or ((ap_const_logic_1 = ap_CS_fsm_state5) and (tmp_2_fu_313_p2 = ap_const_lv1_1)) or (ap_const_logic_1 = ap_CS_fsm_state15) or (ap_const_logic_1 = ap_CS_fsm_state17))) then 
    ...
    array_r_d0_assign_proc : process(b0_a0_V, ap_CS_fsm_state1, ap_CS_fsm_state16, a2_a0_V_read_reg_873, b2_a0_V_read_reg_883, ap_CS_fsm_state4, inDataRight_V_trunc_fu_309_p1, ap_CS_fsm_state14, ap_CS_fsm_state2, ap_CS_fsm_state3, samples_V_load11_tru_fu_829_p1, ap_CS_fsm_state15, samples_V_load_114_t_fu_846_p1, samples_V_load_217_t_fu_850_p1, ap_CS_fsm_state17, samples_V_load_320_t_fu_859_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state17)) then 
    ...
    array_r_d1_assign_proc : process(b1_a0_V, ap_CS_fsm_state1, ap_CS_fsm_state16, a1_a0_V_read_reg_878, inDataLeft_V_trunc_fu_305_p1, inDataLeft_V_trunc_reg_888, ap_CS_fsm_state4, inDataRight_V_trunc_reg_893, ap_CS_fsm_state14, ap_CS_fsm_state2, p_Val2_trunc_fu_833_p1, ap_CS_fsm_state15, p_Val2_5_trunc_fu_854_p1, ap_CS_fsm_state17)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state17)) then 
    ...
    array_r_we0_assign_proc : process(inDataLeft_V_ap_vld, inDataRight_V_ap_vld, ap_CS_fsm_state1, ap_CS_fsm_state16, ap_CS_fsm_state4, ap_CS_fsm_state14, ap_block_state16_io, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state15, ap_CS_fsm_state17)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = inDataRight_V_ap_vld) or (ap_const_logic_0 = inDataLeft_V_ap_vld)))) or (ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state14) or ((ap_const_logic_1 = ap_CS_fsm_state16) and (ap_block_state16_io = ap_const_boolean_0)) or (ap_const_logic_1 = ap_CS_fsm_state2) or (ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state15) or (ap_const_logic_1 = ap_CS_fsm_state17))) then 
    ...
    array_r_we1_assign_proc : process(inDataLeft_V_ap_vld, inDataRight_V_ap_vld, ap_CS_fsm_state1, ap_CS_fsm_state16, ap_CS_fsm_state4, ap_CS_fsm_state14, ap_block_state16_io, ap_CS_fsm_state2, ap_CS_fsm_state15, ap_CS_fsm_state17)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = inDataRight_V_ap_vld) or (ap_const_logic_0 = inDataLeft_V_ap_vld)))) or (ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state14) or ((ap_const_logic_1 = ap_CS_fsm_state16) and (ap_block_state16_io = ap_const_boolean_0)) or (ap_const_logic_1 = ap_CS_fsm_state2) or (ap_const_logic_1 = ap_CS_fsm_state15) or (ap_const_logic_1 = ap_CS_fsm_state17))) then 
    ...
    inDataLeft_V_ap_ack_assign_proc : process(inDataLeft_V_ap_vld, inDataRight_V_ap_vld, ap_CS_fsm_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = inDataRight_V_ap_vld) or (ap_const_logic_0 = inDataLeft_V_ap_vld))))) then 
    ...
    inDataLeft_V_blk_n_assign_proc : process(inDataLeft_V_ap_vld, ap_CS_fsm_state1)
    begin
    ...
    inDataRight_V_ap_ack_assign_proc : process(inDataLeft_V_ap_vld, inDataRight_V_ap_vld, ap_CS_fsm_state1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and not(((ap_const_logic_0 = inDataRight_V_ap_vld) or (ap_const_logic_0 = inDataLeft_V_ap_vld))))) then 
    ...
    inDataRight_V_blk_n_assign_proc : process(inDataRight_V_ap_vld, ap_CS_fsm_state1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
