...
#ifndef __biquadv2between_mcud__HH__
#define __biquadv2between_mcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(biquadv2between_mcud) {
    ...
    SC_CTOR(biquadv2between_mcud):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
