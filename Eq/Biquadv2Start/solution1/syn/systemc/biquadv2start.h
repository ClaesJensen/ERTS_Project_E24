...
#ifndef _biquadv2start_HH_
#define _biquadv2start_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "biquadv2start_mulcud.h"
#include "biquadv2start_arrbkb.h"
#include "biquadv2start_biquadv2_s_axi.h"

namespace ap_rtl {

template<unsigned int C_S_AXI_BIQUADV2_ADDR_WIDTH = 7,
         unsigned int C_S_AXI_BIQUADV2_DATA_WIDTH = 32>
struct biquadv2start : public sc_module {
    ...
    // Module declarations
    biquadv2start(sc_module_name name);
    SC_HAS_PROCESS(biquadv2start);
    ...
    biquadv2start_arrbkb* array_r_U;
    biquadv2start_biquadv2_s_axi<C_S_AXI_BIQUADV2_ADDR_WIDTH,C_S_AXI_BIQUADV2_DATA_WIDTH>* biquadv2start_biquadv2_s_axi_U;
    biquadv2start_mulcud<1,2,27,24,51>* biquadv2start_mulcud_U0;
    ...
    sc_signal< sc_lv<24> > inDataLeft_V;
    sc_signal< sc_lv<24> > inDataRight_V;
