...
#ifndef __biquadv2start_mulcud__HH__
#define __biquadv2start_mulcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(biquadv2start_mulcud) {
    ...
    SC_CTOR(biquadv2start_mulcud):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
