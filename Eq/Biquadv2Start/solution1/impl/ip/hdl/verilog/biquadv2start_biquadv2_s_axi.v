...
`timescale 1ns/1ps
module biquadv2start_biquadv2_s_axi
#(parameter
    ...
    output wire [23:0]                   inDataLeft_V,
    output wire [23:0]                   inDataRight_V
);
//------------------------Address Info-------------------
// 0x00 : reserved
// 0x04 : reserved
...
localparam
    ...
    ADDR_INDATALEFT_V_DATA_0  = 7'h38,
    ADDR_INDATALEFT_V_CTRL    = 7'h3c,
    ADDR_INDATARIGHT_V_DATA_0 = 7'h40,
    ADDR_INDATARIGHT_V_CTRL   = 7'h44,
    WRIDLE                    = 2'd0,
    WRDATA                    = 2'd1,
    WRRESP                    = 2'd2,
    WRRESET                   = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [23:0]                   int_inDataLeft_V = 'b0;
    reg  [23:0]                   int_inDataRight_V = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_INDATALEFT_V_DATA_0: begin
                    rdata <= int_inDataLeft_V[23:0];
                end
                ADDR_INDATARIGHT_V_DATA_0: begin
                    rdata <= int_inDataRight_V[23:0];
                end
            endcase
        end
    end
...
assign inDataLeft_V  = int_inDataLeft_V;
assign inDataRight_V = int_inDataRight_V;
// int_b0_a0_V[26:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_b0_a0_V[26:0] <= 0;
...
// int_inDataLeft_V[23:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_inDataLeft_V[23:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_INDATALEFT_V_DATA_0)
            int_inDataLeft_V[23:0] <= (WDATA[31:0] & wmask) | (int_inDataLeft_V[23:0] & ~wmask);
    end
end

// int_inDataRight_V[23:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_inDataRight_V[23:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_INDATARIGHT_V_DATA_0)
            int_inDataRight_V[23:0] <= (WDATA[31:0] & wmask) | (int_inDataRight_V[23:0] & ~wmask);
    end
end
