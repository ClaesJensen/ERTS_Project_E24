...
$(ObjDir)/biquadv2start_test.cpp_pre.cpp.tb.o : biquadv2start_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling biquadv2start_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/biquadv2start.cpp_pre.cpp.tb.o : biquadv2start.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling biquadv2start.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
