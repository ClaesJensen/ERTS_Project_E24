...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "biquadv2start.autotvin.dat"
	set constFileTvOut       "biquadv2start.autotvout.dat"
	set constFileHdlTvIn     "biquadv2start.autohdltvin.dat"
	set constFileHdlTvOut    "biquadv2start.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
