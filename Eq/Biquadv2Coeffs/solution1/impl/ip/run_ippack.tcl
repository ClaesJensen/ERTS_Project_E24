...
set Library     "hls"
set IPName      "Biquadv2coeffs"
set Version     "1.0"
set DisplayName "Biquadv2coeffs"
set Revision    "2113877510"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "Biquadv2coeffs"
...
set Interfaces {
    s_axi_coeffs {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_coeffs"
        param_prefix "C_S_AXI_COEFFS"
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {{0x10 in0b0_a0_V W 0x0 "Data signal of in0b0_a0_V" {{0 27 in0b0_a0_V W 0 "Bit 26 to 0 Data signal of in0b0_a0_V"} {27 5 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 in0b1_a0_V W 0x0 "Data signal of in0b1_a0_V" {{0 27 in0b1_a0_V W 0 "Bit 26 to 0 Data signal of in0b1_a0_V"} {27 5 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 in0b2_a0_V W 0x0 "Data signal of in0b2_a0_V" {{0 27 in0b2_a0_V W 0 "Bit 26 to 0 Data signal of in0b2_a0_V"} {27 5 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 in0a1_a0_V W 0x0 "Data signal of in0a1_a0_V" {{0 27 in0a1_a0_V W 0 "Bit 26 to 0 Data signal of in0a1_a0_V"} {27 5 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 in0a2_a0_V W 0x0 "Data signal of in0a2_a0_V" {{0 27 in0a2_a0_V W 0 "Bit 26 to 0 Data signal of in0a2_a0_V"} {27 5 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
set enable_xo_gen 0
set kernel_files {C:/Users/lions/Desktop/Github/ERTS_Project_E24/Eq/Biquadv2Coeffs/biquadv2coeffs.cpp}
if {$enable_xo_gen} {
